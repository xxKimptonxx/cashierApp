...
__all__ = [
    'SPPHRASEELEMENT', 'DISPID_SPCIdToPhone',
    'SPEI_START_INPUT_STREAM', 'DISPID_SABIMinNotification',
    'DISPID_SPRuleChildren', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_RESERVED6', 'DISPID_SPRsCount', 'SpeechEngineProperties',
    'DISPID_SPELexicalForm', 'SBOPause', 'SpeechAudioVolume',
    'SPINTERFERENCE_NOISE', 'DISPID_SGRSTPropertyName',
    'DISPID_SWFEBlockAlign', 'DISPID_SPRuleId', 'SPEI_SR_PRIVATE',
    'DISPID_SPIAudioSizeTime', 'SpeechRecoEvents',
    'SpeechAudioFormatGUIDWave', 'SP_VISEME_5',
    'DISPID_SLGetGenerationChange', 'SPXMLRESULTOPTIONS',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SOTSetId',
    'SAFT44kHz8BitMono', 'SDKLLocalMachine', 'SPCATEGORYTYPE',
    'DISPID_SpeechPhraseReplacement', 'SPPS_NotOverriden',
    'eLEXTYPE_USER', 'DISPID_SpeechGrammarRules',
    'SpPhraseInfoBuilder', 'SVSFVoiceMask', 'SPAUDIOSTATUS',
    'DISPID_SPPChildren', 'DISPID_SRCEventInterests',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRRAlternates',
    'SVESentenceBoundary', 'DISPID_SPIEngineId', 'ISpPhoneConverter',
    'SpResourceManager', 'DISPID_SGRSTText', 'SPPS_SuppressWord',
    'ISpeechAudioFormat', 'SAFTADPCM_22kHzStereo',
    'DISPID_SGRAddState', 'SP_VISEME_13', 'ISpeechGrammarRuleState',
    'SVP_14', 'DISPID_SOTIsUISupported',
    ...
    'DISPID_SpeechVoiceStatus', 'DISPID_SAStatus', 'DISPID_SGRName',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVSVisemeId',
    'ISpRecoGrammar2', 'Speech_Max_Pron_Length',
    'DISPID_SRRTTickCount', 'SREPhraseStart',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRSSupportedLanguages',
    'ISpRecoCategory', 'SpeechDisplayAttributes',
    'eLEXTYPE_PRIVATE20', 'DISPID_SABufferNotifySize',
    'DISPID_SRGCmdSetRuleIdState', 'SVSFIsXML',
    'DISPID_SRCEAudioLevel', 'SRSEDone', 'DISPID_SRCEInterference',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SOTs_NewEnum',
    'DISPID_SGRs_NewEnum', 'DISPID_SPPsCount', 'SREPrivate',
    'SPBINARYGRAMMAR', 'DISPID_SPRuleName',
    'SpeechTokenIdUserLexicon', 'SDA_Consume_Leading_Spaces',
    'SPPHRASEPROPERTY', 'ISpeechLexiconWords', 'ISpeechDataKey',
    'DISPID_SPAs_NewEnum', 'DISPID_SVEVoiceChange',
    '__MIDL_IWinTypes_0009', 'SAFT16kHz16BitMono',
    'DISPID_SWFESamplesPerSec', 'SAFTADPCM_8kHzMono',
    'ISpeechXMLRecoResult', 'DISPID_SLPSymbolic',
    'DISPID_SABufferInfo', 'SAFTADPCM_11kHzStereo',
    'SAFT11kHz16BitMono', 'DISPID_SOTRemoveStorageFileName',
    'SP_VISEME_11', 'eWORDTYPE_DELETED',
    'DISPID_SRCRetainedAudioFormat', 'SPPHRASERULE',
    'DISPID_SDKGetStringValue', 'SpeechWordPronounceable',
    'SGDSActiveWithAutoPause', 'DISPIDSPTSI_SelectionOffset',
    'SP_VISEME_16', 'DISPID_SpeechLexiconWord',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechAudio',
    'SAFTCCITT_ALaw_44kHzMono', 'SpPhoneticAlphabetConverter',
    'SpShortcut', 'DISPID_SVVolume', 'DISPID_SGRSTsItem',
    'SpeechStreamSeekPositionType', 'ISpRecognizer3',
    'DISPID_SOTCategory', 'SpeechLexiconType', 'DISPID_SRCEEndStream',
    'DISPID_SVSRunningState', 'eLEXTYPE_RESERVED10',
    'SAFT32kHz8BitStereo', 'DISPID_SRGetRecognizers',
    'SRAInterpreter', 'DISPID_SRStatus', 'ISpMMSysAudio',
    'SVSFParseMask', 'DISPID_SPRuleFirstElement',
    '_ISpeechRecoContextEvents', 'SpeechCategoryAudioOut',
    'SPPS_Verb', 'SPEI_UNDEFINED', 'SPEI_SR_AUDIO_LEVEL',
    ...
    'SpeechPartOfSpeech', 'SPSSuppressWord', 'DISPID_SLPsCount',
    'SVSFIsFilename', 'SPEI_RECO_STATE_CHANGE', 'SGRSTTTextBuffer',
    'SREAllEvents', 'SPSMF_SAPI_PROPERTIES', 'DISPID_SAFType',
    'DISPID_SDKSetLongValue', 'DISPID_SLWsCount', 'SP_VISEME_6',
    'SRATopLevel', 'IInternetSecurityMgrSite', 'SSFMCreateForWrite',
    'SPAS_CLOSED', 'STSF_AppData', 'DISPID_SOTCId',
    'DISPID_SPACommit', 'SpeechBookmarkOptions',
    ...
    'DISPID_SpeechLexiconProns', 'DISPID_SVRate', 'SPVISEMES',
    'eLEXTYPE_PRIVATE2', 'SpLexicon', 'SPRST_ACTIVE', 'SPEI_VISEME',
    'SPEI_RECOGNITION', 'SPBOOKMARKOPTIONS', 'DISPID_SVVoice',
    'ISpeechPhraseReplacements', 'DISPID_SpeechVoice',
    'STCInprocServer', '_SPAUDIOSTATE', 'eLEXTYPE_APP',
    'SRESoundStart', 'SGPronounciation', 'DISPID_SPAsItem',
    'SpeechEmulationCompareFlags', 'ISpeechPhraseInfo',
    'SRTSMLTimeout', 'DISPID_SAVolume', 'SpeechDataKeyLocation',
    'ISpStreamFormatConverter', 'SAFT32kHz8BitMono',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPRDisplayAttributes',
    'SECFIgnoreCase', 'SAFT12kHz8BitMono', 'DISPID_SpeechDataKey',
    'DISPID_SLWType', 'DISPID_SVGetProfiles', 'SAFTADPCM_44kHzMono',
    'ISpeechGrammarRule', 'IInternetSecurityManager',
    'DISPID_SPEActualConfidence', 'SPAR_Unknown',
    'ISpPhoneticAlphabetConverter', 'SP_VISEME_17',
    'ISpGrammarBuilder', 'DISPID_SVPriority', 'eLEXTYPE_PRIVATE19',
    'SpeechGrammarTagUnlimitedDictation', 'ISpRecoGrammar',
    'SREBookmark', 'ISpRecoContext2', 'SDA_One_Trailing_Space',
    'SpStreamFormatConverter', 'DISPID_SPAsCount',
    'eLEXTYPE_PRIVATE17', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SOTDisplayUI', 'SAFTADPCM_8kHzStereo',
    'ISequentialStream', 'DISPID_SVSInputSentenceLength',
    'SAFT48kHz16BitStereo', 'SVP_5', 'SpeechPropertyAdaptationOn',
    'SPSHT_NotOverriden', 'SAFTCCITT_uLaw_11kHzMono', 'SGSExclusive',
    'ISpeechPhraseProperty', 'SDTRule', 'DISPID_SGRsFindRule',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechVoicePriority',
    'SREAudioLevel', 'SpeechVoiceEvents', 'SPEVENTENUM', 'SVPNormal',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechPhraseReplacements',
    'SGDisplay', 'STCLocalServer', 'DISPID_SpeechRecognizerStatus',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechMMSysAudio',
    'SRAORetainAudio', 'SAFT22kHz16BitMono', 'SPEI_END_SR_STREAM',
    'SpMMAudioOut', 'SAFT24kHz16BitStereo', 'SpeechRecognizerState',
    'LONG_PTR', 'DISPID_SPANumberOfElementsInResult',
    'SRERecognition', 'ISpeechWaveFormatEx', 'SPPS_RESERVED2',
    'DISPID_SPEs_NewEnum', 'SDKLCurrentConfig', 'DISPID_SPPsItem',
    'SPBO_TIME_UNITS', 'DISPID_SOTMatchesAttributes',
    'ISpResourceManager', 'SRAImport', 'SpeechAllElements',
    'eLEXTYPE_RESERVED7', 'SDTAll', 'IStream',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SMSGetData',
    'SpInProcRecoContext', 'DISPID_SVAlertBoundary', 'ISpeechLexicon',
    'SVPOver', 'SPWT_DISPLAY', 'DISPID_SOTId', 'SPEI_WORD_BOUNDARY',
    'SPINTERFERENCE', 'SVP_17', 'SPSHT_EMAIL', 'SP_VISEME_9',
    'SREFalseRecognition', 'SPPS_Modifier', 'SpeechUserTraining',
    'Speech_Max_Word_Length', 'DISPID_SpeechLexiconWords',
    'SAFTADPCM_22kHzMono', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPCPhoneToId', 'SPEI_MAX_SR', 'ISpStreamFormat',
    'SECFIgnoreKanaType', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRRSetTextFeedback', 'SpeechPropertyResponseSpeed',
    'DISPID_SPRuleEngineConfidence', 'SWPKnownWordPronounceable',
    'SpObjectTokenCategory', 'SRSActive', 'DISPID_SPRuleConfidence',
    'DISPID_SLWsItem', 'DISPID_SPISaveToMemory',
    'DISPID_SpeechXMLRecoResult', 'SVSFlagsAsync',
    'ISpeechVoiceStatus', 'STCInprocHandler',
    'SPEI_FALSE_RECOGNITION', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SOTRemove', 'SPCS_ENABLED', 'SGDSActive',
    'DISPID_SVEStreamStart', 'SPSTREAMFORMATTYPE', 'SPRS_ACTIVE',
    'ISpeechResourceLoader', 'SVP_19', 'SpeechAudioFormatType',
    'SVF_None', 'SAFT24kHz8BitStereo', 'SpMemoryStream',
    'DISPID_SpeechPhoneConverter', 'ISpSerializeState', 'SpStream',
    'SAFT16kHz8BitMono', 'SAFT16kHz8BitStereo', 'SAFT11kHz8BitMono',
    'SPFM_NUM_MODES', 'SPPHRASE', 'SPFILEMODE',
    'SRSInactiveWithPurge', 'DISPID_SRIsUISupported', 'SPGS_ENABLED',
    'DISPID_SpeechPhraseRules', 'SVP_20', 'SAFT8kHz16BitMono',
    'DISPID_SRGDictationUnload', 'SPAUDIOSTATE', 'SECFIgnoreWidth',
    'SPEI_REQUEST_UI', 'SAFTCCITT_ALaw_8kHzMono', 'SPSModifier',
    'ISpeechPhraseRule', 'DISPIDSPTSI_ActiveLength',
    'SpNullPhoneConverter', 'DISPID_SpeechGrammarRuleState',
    'SITooQuiet', 'SPEI_ADAPTATION', 'ISpEventSource',
    'DISPID_SPRsItem', 'SVP_21',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SASetState',
    'SECFEmulateResult', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SLGetWords', 'DISPID_SDKGetBinaryValue',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SLPType', 'SPFM_CREATE',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SABIEventBias',
    'DISPID_SpeechPhraseElements', 'SAFT48kHz16BitMono',
    'DISPID_SOTCSetId', 'SITooFast', 'SAFTCCITT_ALaw_22kHzStereo',
    'SP_VISEME_19', 'DISPID_SVWaitUntilDone',
    'DISPID_SASNonBlockingIO', 'DISPID_SVGetAudioInputs',
    'SVSFParseSsml', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SOTCGetDataKey', 'SPXRO_Alternates_SML',
    'DISPID_SpeechVoiceEvent', 'SPEI_SR_RETAINEDAUDIO', 'SPSVerb',
    'DISPID_SLPs_NewEnum', 'DISPIDSPRG', 'Speech_Default_Weight',
    'DISPID_SBSFormat', 'SITooLoud', 'DISPID_SpeechAudioBufferInfo',
    'SVSFPersistXML', 'eLEXTYPE_PRIVATE13', 'SREHypothesis',
    'SpeechCategoryRecoProfiles', 'DISPID_SpeechRecognizer',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SVPause',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SOTGetDescription', 'SPAUDIOOPTIONS', 'SGRSTTWildcard',
    'SPVPRIORITY', 'DISPID_SDKGetlongValue',
    'DISPID_SpeechAudioFormat', 'SpeechGrammarTagWildcard',
    'SPPS_LMA', 'DISPID_SVEAudioLevel', 'SECFDefault',
    ...
    'SpCustomStream', 'SPCT_SUB_COMMAND', 'DISPID_SVSpeakStream',
    'SVSFDefault', 'SpeechRetainedAudioOptions', 'ISpeechAudioStatus',
    'ISpeechObjectToken', 'DISPID_SOTDataKey', 'SRTReSent',
    'SGSEnabled', 'SVF_Emphasis', 'DISPID_SMSALineId',
    'DISPID_SRGIsPronounceable', 'SPEI_HYPOTHESIS',
    'ISpeechGrammarRules', 'SP_VISEME_20', 'SVP_16',
    'SPSERIALIZEDRESULT', 'DISPID_SGRSTsCount', 'DISPID_SPPParent',
    'SPVPRI_NORMAL', 'SAFT8kHz8BitStereo', 'DISPID_SFSClose',
    'DISPID_SLWPronunciations', 'DISPID_SRCAudioInInterferenceStatus',
    'SLODynamic', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpMMAudioIn',
    'DISPID_SpeechAudio', 'SpSharedRecognizer', 'SGRSTTDictation',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRInitialState',
    'eLEXTYPE_RESERVED8', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRCESoundEnd', 'SRTStandard',
    ...
    'SGDSInactive', 'DISPID_SRRGetXMLResult', 'DISPID_SGRSTType',
    'DISPID_SDKSetBinaryValue', 'SAFT12kHz8BitStereo',
    'SpeechTokenShellFolder', 'SVSFUnusedFlags', 'DISPID_SRDisplayUI',
    'ISpeechFileStream', 'SPPS_Noun', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpCompressedLexicon', 'SVSFIsNotXML', 'SPSEMANTICERRORINFO',
    'ISpObjectToken', 'SREInterference', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechRecoContextEvents', 'SVP_13',
    'DISPID_SRGCmdLoadFromFile', 'SPEI_MIN_TTS', 'SINoise',
    'SPAR_High', 'SP_VISEME_18', 'SPSHORTCUTTYPE',
    'DISPID_SRRSaveToMemory', 'SpeechDiscardType', 'SLOStatic',
    'ISpAudio', 'SVEAudioLevel', 'SAFT22kHz8BitStereo', 'SRADynamic',
    'SPBO_PAUSE', 'DISPID_SRGCmdSetRuleState',
    'ISpeechRecoResultTimes', 'DISPID_SVResume', 'SPSLMA',
    'DISPID_SPIRule', 'SpVoice', 'DISPID_SLWs_NewEnum',
    'SPEI_SOUND_END', 'SAFTExtendedAudioFormat', 'SBONone',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPPFirstElement',
    'ISpeechPhraseProperties', 'DISPID_SGRSRule', 'SpMMAudioEnum',
    'DISPID_SASState', 'DISPID_SVEventInterests',
    'DISPID_SGRsCommitAndSave', 'SVP_9', 'SP_VISEME_3',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechObjectTokenCategory', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFT22kHz16BitStereo', 'SPDKL_DefaultLocation', 'ISpPhraseAlt',
    'SP_VISEME_0', 'DISPID_SpeechObjectTokens',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechRecoResultDispatch',
    'ISpeechLexiconWord', 'eLEXTYPE_PRIVATE18', 'SPCONTEXTSTATE',
    'SFTInput', 'SPEI_END_INPUT_STREAM', 'SpeechRunState',
    'DISPID_SWFEChannels', 'SPSHT_Unknown', 'SVEEndInputStream',
    'DISPID_SBSWrite', 'DISPID_SRCEAdaptation', 'SVP_3',
    'SDTProperty', 'ISpeechRecoResult2', 'SPSUnknown',
    'DISPID_SDKDeleteValue', 'SPEI_VOICE_CHANGE', 'SPEI_RESERVED5',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPRulesCount',
    'ISpeechLexiconPronunciation', 'SpeechMicTraining',
    'DISPID_SRGCommit', 'DISPID_SGRClear', 'SDTAudio',
    'SpeechSpecialTransitionType', 'SpeechEngineConfidence',
    'DISPID_SPIProperties', 'SPSEMANTICFORMAT', 'SINoSignal',
    'SPAO_NONE', 'DISPID_SRCVoice', 'DISPID_SLPPhoneIds',
    'SPEI_RESERVED1', 'SPEI_PHONEME', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRRPhraseInfo', 'SPLO_STATIC', 'SPEI_RESERVED3',
    'SVEViseme', 'DISPID_SDKCreateKey', 'DISPID_SVSkip', 'SGRSTTRule',
    'DISPID_SpeechLexicon', 'SpeechInterference',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPRules_NewEnum',
    'DISPID_SVSInputWordLength', 'ISpeechRecoResult',
    'DISPID_SpeechMemoryStream', 'SP_VISEME_2',
    'DISPID_SRGetPropertyString', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPLEXICONTYPE', 'SPLOADOPTIONS', 'SpeechRuleState',
    'SPRULESTATE', 'DISPID_SRSCurrentStreamPosition',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRCEHypothesis',
    'ISpStream', 'DISPID_SpeechPhraseElement', 'SPDKL_LocalMachine',
    'SpeechRecoContextState', 'DISPID_SPIRetainedSizeBytes',
    'SPFM_CREATE_ALWAYS', 'eLEXTYPE_PRIVATE7', 'SAFT44kHz8BitStereo',
    'SRERecoOtherContext', 'DISPID_SGRSTransitions',
    'SAFT8kHz16BitStereo', 'DISPID_SVEStreamEnd', 'SP_VISEME_12',
    'ISpNotifySource', 'SpeechPropertyHighConfidenceThreshold',
    'SREAdaptation', 'DISPID_SPRFirstElement', 'SDTAlternates',
    'DISPID_SRCESoundStart', 'tagSPTEXTSELECTIONINFO', 'SPWORDLIST',
    'SVP_18', 'SRTExtendableParse', 'SVP_11', 'SAFT11kHz8BitStereo',
    'DISPID_SPPNumberOfElements', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVIsUISupported',
    'DISPID_SRState', 'DISPID_SRGetPropertyNumber',
    'eLEXTYPE_PRIVATE8', 'DISPID_SMSADeviceId',
    'DISPID_SLGenerationId', 'DISPID_SGRAddResource',
    'ISpeechObjectTokenCategory', 'SpeechCategoryVoices',
    'SPSInterjection', 'SPDATAKEYLOCATION', 'DISPID_SFSOpen',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRGDictationSetState',
    'SRSInactive', 'ISpeechRecognizer', 'DISPID_SGRAttributes',
    'SVEAllEvents', 'DISPID_SVEViseme', 'SPRST_INACTIVE',
    'SpeechAudioFormatGUIDText', 'DISPID_SRGState',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPERetainedSizeBytes',
    'SpeechCategoryPhoneConverters', 'SVEPhoneme',
    'DISPID_SVEBookmark', 'SAFTCCITT_uLaw_44kHzStereo', 'SVP_4',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRSAddWordTransition',
    'ISpeechCustomStream', 'ISpeechMemoryStream',
    'DISPID_SRRecognizer', 'ISpeechRecoContext', 'eLEXTYPE_PRIVATE1',
    'tagSTATSTG', 'SpeechGrammarWordType', 'SAFT48kHz8BitMono',
    'ISpRecoResult', 'DISPID_SRGSetTextSelection',
    'DISPID_SRRSpeakAudio', 'DISPID_SRRTLength',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechPhraseInfo', 'SFTSREngine',
    'DISPID_SPPs_NewEnum', 'SLTUser', 'DISPID_SREmulateRecognition',
    'SRTAutopause', 'Speech_StreamPos_RealTime',
    'SPINTERFERENCE_NONE', 'SPLO_DYNAMIC', 'SPAS_PAUSE',
    'DISPID_SpeechWaveFormatEx', 'SPEI_PROPERTY_STRING_CHANGE',
    'SAFT24kHz8BitMono', 'SREPropertyNumChange',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechRecoResult2',
    'DISPID_SASFreeBufferSpace', 'SPEVENT', 'SPGS_EXCLUSIVE',
    'eLEXTYPE_VENDORLEXICON', 'SPEI_SR_BOOKMARK',
    'ISpObjectWithToken', 'SRADefaultToActive', 'SPPS_Noncontent',
    'DISPID_SVEPhoneme', 'DISPID_SLAddPronunciation',
    'SPSHORTCUTPAIR', 'SPCS_DISABLED', 'DISPID_SVGetAudioOutputs',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SDKEnumKeys',
    'DISPID_SWFEFormatTag', 'SpeechAddRemoveWord', 'ISpProperties',
    'SAFTNonStandardFormat', 'DISPID_SRCEStartStream',
    'DISPID_SPAStartElementInResult', 'SPAR_Medium',
    'DISPID_SPIStartTime', 'SPVOICESTATUS',
    'DISPID_SLRemovePronunciation', 'UINT_PTR',
    'ISpeechPhraseReplacement', 'SASClosed',
    'DISPID_SAFGetWaveFormatEx', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechRecoContext', 'SSFMCreate', 'SSFMOpenForRead',
    'SDKLCurrentUser', 'SpeechLoadOption',
    'SWPUnknownWordUnpronounceable', 'SpNotifyTranslator',
    'DISPID_SPEsItem', 'SPEI_SOUND_START', 'DISPID_SAFGuid',
    'DISPID_SPIAudioStreamPosition', 'SVP_12', 'SPEI_RESERVED2',
    'SAFTCCITT_ALaw_22kHzMono', 'SPXRO_SML', 'SPCT_SUB_DICTATION',
    'DISPIDSPTSI', 'DISPID_SPRText', 'SpeechTokenKeyAttributes',
    'SRARoot', 'DISPID_SGRsAdd', 'SP_VISEME_10', 'DISPID_SPPId',
    'SRCS_Enabled', 'ISpeechLexiconPronunciations', 'STCAll',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPS_RESERVED3',
    '_ISpeechVoiceEvents', 'SpeechGrammarRuleStateTransitionType',
    'ISpRecognizer', 'ISpEventSink', 'DISPID_SBSSeek',
    'DISPID_SRCEPhraseStart', 'SASPause', 'SPEI_TTS_BOOKMARK',
    'SAFTGSM610_44kHzMono', 'SPWORD', 'DISPID_SRRAudio',
    'SP_VISEME_8', 'SRSEIsSpeaking', 'SRCS_Disabled',
    'SpeechRuleAttributes', 'DISPID_SPEDisplayAttributes',
    'SECNormalConfidence', 'SECHighConfidence', 'SPPS_RESERVED4',
    'DISPID_SGRSTNextState', 'SpeechVisemeFeature',
    'SpeechPropertyLowConfidenceThreshold', 'SPPARTOFSPEECH',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpRecognizer2',
    'ISpeechBaseStream', 'SPCT_SLEEP', 'SREPropertyStringChange',
    'DISPID_SVSLastBookmark', 'DISPID_SVSPhonemeId',
    'SAFT44kHz16BitStereo', 'SPVPRI_ALERT', 'SPPS_Interjection',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRGDictationLoad', 'SPRULE',
    ...
    'DISPID_SRIsShared', 'DISPID_SGRSTWeight', 'DISPID_SGRsDynamic',
    'SpeechStreamFileMode', 'DISPID_SRCEBookmark',
    'SPEVENTSOURCEINFO', 'DISPID_SVSInputSentencePosition',
    'SSSPTRelativeToStart', 'SDTLexicalForm',
    'DISPID_SGRSAddRuleTransition', 'SVP_10', 'DISPID_SPEsCount',
    'SPPS_Function', 'SAFT12kHz16BitMono',
    'DISPID_SVSpeakCompleteEvent', 'SpInprocRecognizer',
    'DISPID_SRCERecognition', 'ISpObjectTokenCategory',
    'DISPID_SOTsCount', 'SVP_7', 'ISpNotifyTranslator', 'SVPAlert',
    'SPDKL_CurrentUser', 'STCRemoteServer', 'SASStop',
    'DISPID_SVESentenceBoundary', 'ISpRecoContext',
    'DISPID_SPERequiredConfidence', 'SVSFNLPSpeakPunc',
    'DISPID_SPPName', 'SPPROPERTYINFO', 'DISPID_SLPsItem',
    'eLEXTYPE_PRIVATE10', 'SWTDeleted', 'SPGS_DISABLED',
    'SAFT22kHz8BitMono', 'DISPID_SPIGrammarId',
    'SAFT11kHz16BitStereo', 'DISPID_SRRTStreamTime',
    'DISPID_SRSAudioStatus', 'DISPID_SVSLastBookmarkId',
    'DISPID_SpeechPhraseAlternates', 'SPAR_Low', 'SPEI_MIN_SR',
    'DISPID_SLPPartOfSpeech', 'SAFT32kHz16BitStereo', 'SREStreamEnd',
    'SPWT_PRONUNCIATION', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPCLangId', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SpeechRecoResult', 'ISpeechAudioBufferInfo',
    'IEnumString', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SVSInputWordPosition',
    'SGLexical', 'eLEXTYPE_PRIVATE14', 'ISpLexicon',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRCreateRecoContext',
    'SPINTERFERENCE_NOSIGNAL', 'SPSFunction', 'SP_VISEME_7',
    'DISPID_SOTsItem', 'SREStateChange', 'SpWaveFormatEx',
    'WAVEFORMATEX', 'SPADAPTATIONRELEVANCE', 'SDKLDefaultLocation',
    'eLEXTYPE_PRIVATE9', 'DISPID_SOTCEnumerateTokens',
    'SPEI_RECO_OTHER_CONTEXT', 'STSF_LocalAppData',
    'SGDSActiveUserDelimited', 'SPCT_DICTATION',
    'SpeechCategoryRecognizers', 'DISPID_SPPEngineConfidence',
    'SINone', 'SVEWordBoundary', 'DISPID_SRGReset',
    'ISpeechPhraseAlternates', 'SpeechVisemeType',
    'DISPID_SDKDeleteKey', 'SAFT48kHz8BitStereo', 'DISPID_SRGId',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRGetFormat',
    'DISPID_SVGetVoices', 'SPWT_LEXICAL', 'DISPID_SPIGetText',
    '_RemotableHandle', 'DISPID_SABIBufferSize',
    'SpeechPropertyComplexResponseSpeed', 'SPINTERFERENCE_TOOLOUD',
    'SpeechVoiceSpeakFlags', 'SWTAdded', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SpeechPhraseProperty', 'DISPID_SDKSetStringValue',
    'eLEXTYPE_PRIVATE16', 'DISPID_SpeechAudioStatus',
    'SECLowConfidence', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SECFNoSpecialChars', 'DISPID_SRCBookmark', 'SPBO_AHEAD',
    'SPPS_Unknown', 'DISPID_SPEAudioTimeOffset', 'SPSNotOverriden',
    'ISpeechObjectTokens', 'SPSMF_UPS', 'eLEXTYPE_RESERVED6',
    'DISPID_SOTGetAttribute', 'ISpDataKey', 'SVEStartInputStream',
    'SVEVoiceChange', 'SWPUnknownWordPronounceable',
    'SPINTERFERENCE_TOOFAST', 'eLEXTYPE_PRIVATE3', 'SDTReplacement',
    'SAFT32kHz16BitMono', 'SVEPrivate', 'DISPID_SpeechCustomStream',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SOTCDefault',
    'DISPID_SGRSTRule', 'DISPID_SRCERequestUI',
    'DISPID_SPAPhraseInfo', 'SpAudioFormat', 'SREStreamStart',
    'DISPID_SDKEnumValues', 'SAFT16kHz16BitStereo',
    'DISPID_SGRSTPropertyId', 'SPWORDPRONUNCIATION',
    'SAFT12kHz16BitStereo', 'DISPID_SPIReplacements',
    'DISPID_SLGetPronunciations', 'DISPID_SBSRead',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCEPropertyStringChange',
    'SRAONone', 'SPSNoun', 'DISPID_SPRuleNumberOfElements',
    'ISpeechPhraseElements', 'SpeechPropertyResourceUsage',
    'STSF_FlagCreate', 'SPRS_INACTIVE', 'DISPID_SRRRecoContext',
    'DISPID_SWFEExtraData', 'SPVPRI_OVER',
    'DISPID_SVAudioOutputStream', 'SPTEXTSELECTIONINFO',
    'SP_VISEME_15', 'SPWF_SRENGINE', 'DISPID_SVDisplayUI',
    'SSFMOpenReadWrite', 'DISPID_SLPLangId',
    'SpTextSelectionInformation', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPGRAMMARWORDTYPE', 'SVF_Stressed', 'SGLexicalNoSpecialChars',
    'SAFTADPCM_44kHzStereo', 'DISPID_SVEWord',
    'ISpeechPhraseAlternate', 'SGSDisabled', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SVStatus', 'SPWF_INPUT', 'SpeechCategoryAudioIn',
    'DISPID_SPRulesItem', 'eLEXTYPE_PRIVATE12', 'SVP_6',
    'DISPID_SRAudioInput', 'SPEI_INTERFERENCE', 'DISPID_SPRs_NewEnum',
    'SAFT44kHz16BitMono', 'SpeechWordType', 'SPPS_RESERVED1',
    'eLEXTYPE_RESERVED4', 'SPWORDPRONUNCIATIONLIST',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPFM_OPEN_READWRITE',
    'DISPID_SPIElements', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechPhraseElement', 'SP_VISEME_14', 'SpeechTokenContext',
    'DISPID_SPEPronunciation', 'DISPID_SRCRetainedAudio',
    'SRSActiveAlways', 'SPEI_MAX_TTS', 'DISPID_SpeechBaseStream',
    'DISPID_SPILanguageId', 'SVSFParseAutodetect', 'SpeechAudioState',
    'DISPID_SpeechMMSysAudio', 'DISPID_SVAudioOutput', 'DISPID_SGRId',
    'SpeechRegistryLocalMachineRoot', 'ISpeechPhoneConverter',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRCVoicePurgeEvent',
    'ISpeechVoice', 'DISPID_SRCRecognizer', 'IEnumSpObjectTokens',
    'ISpShortcut', 'DISPID_SCSBaseStream', 'DISPID_SGRsCommit',
    'SSTTWildcard', 'SAFTNoAssignedFormat', 'DISPID_SRProfile',
    'DISPID_SpeechGrammarRule', 'DISPID_SPARecoResult',
    'SSSPTRelativeToEnd', 'ISpPhrase', 'DISPID_SPPConfidence',
    'DISPID_SGRSTPropertyValue', 'SpPhoneConverter', 'SGRSTTWord',
    'SPBO_NONE', 'DISPID_SRCCreateGrammar',
    'DISPID_SRGCmdLoadFromMemory', 'SP_VISEME_21', 'SAFTText',
    'DISPID_SRCResume', 'DISPID_SAEventHandle', 'SDTPronunciation',
    'SRAExport', 'SPAUDIOBUFFERINFO', 'DISPID_SRGSetWordSequenceData',
    'eWORDTYPE_ADDED', 'DISPID_SRCSetAdaptationData',
    'SpeechAudioProperties', 'ISpeechPhraseRules',
    'SAFT24kHz16BitMono', 'DISPID_SPPValue',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SITooSlow', 'SAFT8kHz8BitMono',
    'SPEI_PHRASE_START', 'SAFTGSM610_8kHzMono',
    'DISPID_SADefaultFormat', 'SVSFParseSapi',
    'DISPID_SWFEAvgBytesPerSec', 'SpFileStream',
    'SpeechVoiceCategoryTTSRate', 'SP_VISEME_1',
    'SAFTGSM610_22kHzMono', 'DISPID_SRCState', 'DISPID_SMSSetData',
    'ISpeechRecoGrammar', 'SPRECOSTATE', 'SPSHT_OTHER',
    'DISPID_SpeechPhraseProperties', 'DISPID_SVSLastResult',
    'SPRECOGNIZERSTATUS', 'SPCT_COMMAND',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPEI_START_SR_STREAM',
    'SSSPTRelativeToCurrentPosition', 'SPWORDPRONOUNCEABLE',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRGCmdLoadFromObject',
    'SPWAVEFORMATTYPE', 'ISpPhoneticAlphabetSelection', 'SPAS_RUN',
    'SPRST_NUM_STATES', 'ISpeechTextSelectionInformation',
    'SRESoundEnd', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'eLEXTYPE_PRIVATE4', 'SpeechRecognitionType',
    'SPDKL_CurrentConfig', 'ISpNotifySink',
    'DISPID_SAFSetWaveFormatEx', 'ISpXMLRecoResult',
    'Speech_StreamPos_Asap', 'DISPID_SGRsCount',
    'SpeechRecoProfileProperties', 'SSTTTextBuffer', 'SGRSTTEpsilon',
    'SVSFPurgeBeforeSpeak', 'SpUnCompressedLexicon',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVEBookmark', 'SVP_0',
    'DISPID_SRRTimes', 'SLTApp', 'SVSFNLPMask', 'DISPID_SRCPause',
    'ISpVoice', 'SVP_1', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRRGetXMLErrorInfo', 'SVP_8', 'DISPID_SDKOpenKey',
    'DISPID_SGRsItem', 'SASRun', 'DISPID_SRGRecoContext',
    'SPGRAMMARSTATE', 'SDTDisplayText', 'SpeechRegistryUserRoot',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRGRules', 'SPPHRASEREPLACEMENT',
    'SVP_15', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpeechRecognizerStatus', 'DISPID_SPEDisplayText',
    'DISPID_SWFEBitsPerSample', 'SpeechTokenValueCLSID', 'SPAS_STOP',
    'DISPID_SMSAMMHandle', 'DISPID_SRAudioInputStream',
    'SAFTGSM610_11kHzMono', 'SRERequestUI', 'SPSERIALIZEDPHRASE',
    'DISPID_SLWWord', 'SAFTCCITT_uLaw_8kHzMono', 'SVP_2',
    'SpeechGrammarState'
]

_check_version('1.2.0', 1700309199.456953)
